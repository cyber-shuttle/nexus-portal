...
// MetaRow is the under-title fact strip on detail pages (see allocation
// detail spec §7.9 / §8). Each MetaItem renders either a labeled icon+value
// pair or a StatusBadge inline so the row reads as a single horizontal scan.
