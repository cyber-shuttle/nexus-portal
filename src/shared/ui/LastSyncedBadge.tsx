...
const tintStyles: Record<Tint, string> = {
  fresh: "bg-[color:var(--nexus-green-50)] text-[color:var(--nexus-green-700)]",
  stale: "bg-[color:var(--nexus-amber-50)] text-[color:var(--nexus-amber-700)]",
  expired: "bg-[color:var(--nexus-red-50)] text-[color:var(--nexus-red-700)]",
};
