...
// Spec §6.2: max 3 visible segments; collapse the middle when longer so the
// breadcrumb stays single-line at 1440 width.
    ...
    <nav aria-label="Breadcrumb" className="flex items-center text-sm">
      <ol className="flex items-center gap-2">
        {visible.map((item, i) => {
          ...
          // Key derives from the item's identity (href/label or "ellipsis") so React
          // keeps state stable when the path changes.
