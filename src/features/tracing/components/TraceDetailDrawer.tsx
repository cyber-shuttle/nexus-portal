...
// Resolve the first error leaf's action name to append after the error
// summary line. Computed lazily — only meaningful for error-toned traces.
...
function deriveErrorSummary(trace: Trace): string | null {
  const ev = trace.root_event as
    | { error?: unknown; status_message?: unknown }
    | null
    | undefined;
        ...
        <div className="flex-shrink-0 px-6 pt-[18px]">
          <div className="flex items-start gap-3">
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <Tooltip>
                <TooltipTrigger
                  // aria-disabled (vs the disabled prop) keeps the button
                  // focusable so the "coming soon" tooltip stays reachable.
                  render={
                    <Button
                      variant="default"
                      size="sm"
