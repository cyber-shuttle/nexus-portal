...
// Cluster schemas + fetchers live in `@features/allocations` (TF0 architect
// carry-over): clusters are an allocations-domain concept and consumers
// outside admin (proposals, signer) cannot import from `@features/admin`
// under §5 isolation. See `src/features/allocations/schemas.ts`.
